...
{
    public class EquipmentUpdateHandler : IRequestHandler<EquipmentUpdateCommand, Equipment>
    {
        ...
        public async Task<Equipment> Handle(EquipmentUpdateCommand request, CancellationToken cancellationToken)
        {
